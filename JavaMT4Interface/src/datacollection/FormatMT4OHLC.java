...
public class FormatMT4OHLC extends CurrencyCourseCreator {
    ...
    public CurrencyCourseOHLC getCurrencyCourseFromFile(String filename, String currencyPair) throws IOException, ParseException {
        ...
        //TODO how to pass spread?
        line = br.readLine(); //first line actual spread??
        double spread = Double.parseDouble(line);
        CurrencyCourseOHLC cc = new CurrencyCourseOHLC(currencyPair,spread);
