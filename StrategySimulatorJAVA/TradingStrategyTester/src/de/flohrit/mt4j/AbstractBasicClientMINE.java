...
public abstract class AbstractBasicClientMINE implements MT4BasicClientMINE {
    ...
    /**
     * @return the volumeMINE
     */
    public double getVolumeMINE() {
        return volumeMINE;
    }

    /**
     * @param volumeMINE the volumeMINE to set
     */
    public void setVolumeMINE(double volumeMINE) {
        this.volumeMINE = volumeMINE;
    }
}
